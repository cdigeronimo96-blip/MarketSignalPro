...
.sbd-row{display:grid;grid-template-columns:90px 1fr 44px;gap:10px;align-items:center;margin-bottom:11px}
.sbd-lab{font-size:11px;color:#91a3be}
.sbd-bar{height:7px;background:rgba(255,255,255,.06);border-radius:999px;overflow:hidden}
.sbd-fill{height:100%;border-radius:999px;animation:grow 1.8s ease both}
.sbd-fill.green{background:linear-gradient(90deg,#16a34a,#22c55e)}
.sbd-fill.orange{background:linear-gradient(90deg,#d97706,#f59e0b)}
.sbd-val{font-size:11px;font-weight:900;text-align:right;font-family:JetBrains Mono,monospace}
.sbd-val.green{color:#86efac}.sbd-val.orange{color:#fcd34d}

/* Smart Insights panel */
.si-row{display:grid;grid-template-columns:60px 1fr 64px;gap:10px;align-items:center;padding:11px 12px;border:1px solid rgba(255,255,255,.07);background:rgba(2,6,23,.58);border-radius:14px;margin-bottom:9px;border-left:3px solid}
.si-row.buy{border-left-color:#22c55e}.si-row.watch{border-left-color:#f59e0b}.si-row.avoid{border-left-color:#ef4444}
.si-tk{font-family:JetBrains Mono,monospace;color:#60a5fa;font-weight:900;font-size:14px}
.si-txt{font-size:11px;color:#91a3be;line-height:1.4}
  ...
  <div class="dashboard">
    ...
    <div class="body">
      <div class="tabs">
        ...
        <span class="tab" data-tab="1">🎯 Score Breakdown</span>
      ...
      <div class="panel-stack">
        ...
        <div class="panel" data-panel="1">
          <div class="sbd-row"><div class="sbd-lab">Momentum (RSI)</div><div class="sbd-bar"><div class="sbd-fill green" style="width:80%"></div></div><div class="sbd-val green">20/25</div></div>
          <div class="sbd-row"><div class="sbd-lab">Trend (MA20/50)</div><div class="sbd-bar"><div class="sbd-fill green" style="width:90%"></div></div><div class="sbd-val green">18/20</div></div>
          <div class="sbd-row"><div class="sbd-lab">MACD Signal</div><div class="sbd-bar"><div class="sbd-fill green" style="width:86%"></div></div><div class="sbd-val green">13/15</div></div>
          <div class="sbd-row"><div class="sbd-lab">Volume Surge</div><div class="sbd-bar"><div class="sbd-fill orange" style="width:60%"></div></div><div class="sbd-val orange">9/15</div></div>
          <div class="sbd-row"><div class="sbd-lab">Sentiment</div><div class="sbd-bar"><div class="sbd-fill green" style="width:80%"></div></div><div class="sbd-val green">12/15</div></div>
          <div class="mini-grid" style="margin-top:14px">
            <div><b>88</b><span>Composite score</span></div>
            <div><b>5/5</b><span>Signals firing</span></div>
            <div><b>Low</b><span>Risk profile</span></div>
          </div>
          <div class="insight"><strong>Why this score</strong><p>Trading above both 20d and 50d moving averages with confirmed MACD crossover. Volume below recent surge — watch for expansion.</p></div>
        </div>

        <!-- Panel 2: Smart Insights -->
        <div class="panel" data-panel="2">
          <div class="si-row buy"><div class="si-tk">TSLA</div><div class="si-txt">Moving average is breaking out above an important price range — can lead to further upside.</div><div class="si-tag buy">● BUY</div></div>
          <div class="si-row watch"><div class="si-tk">PLUG</div><div class="si-txt">Traders are betting against this stock and momentum is building underneath.</div><div class="si-tag watch">● WATCH</div></div>
          <div class="si-row avoid"><div class="si-tk">AAPL</div><div class="si-txt">May have risen too quickly — could be due for a pullback in the near term.</div><div class="si-tag avoid">● AVOID</div></div>
          <div class="mini-grid" style="margin-top:14px">
  ...
  function activate(idx){
    ...
    panels.forEach(function(p){
      ...
      if (on) {
        ...
        p.querySelectorAll('.bar span, .sbd-fill').forEach(function(b){
          var w = b.style.width;
