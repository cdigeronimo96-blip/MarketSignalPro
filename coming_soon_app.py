...
/* Right-align the left column's content so headline, form & proof
   pills all hug the center gutter (next to the preview).            */
[data-testid="stHorizontalBlock"]:has(.msp-eyebrow) > [data-testid="column"]:first-of-type {
...
/* Left-align the preview snugly against the gutter */
...
/* Headline + subhead sized to fit the narrower left column cleanly */
[data-testid="stHorizontalBlock"]:has(.msp-eyebrow) .msp-h1,
[data-testid="stHorizontalBlock"]:has(.msp-eyebrow) .msp-subhead,
[data-testid="stHorizontalBlock"]:has(.msp-eyebrow) .msp-proof {
    max-width: 520px !important;
    width: 100% !important;
}
...
@media(max-width:980px){.dashboard{transform:none}.visual{min-height:720px}}
</style>
</head>
<body>
<div class="visual">
...
@media(max-width:980px){.feature-grid{grid-template-columns:1fr}.ai-card{width:280px;height:200px}}
</style>
</head>
<body>
