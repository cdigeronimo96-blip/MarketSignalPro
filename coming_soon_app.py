...
@media (max-width: 620px) {
    ...
    /* ── Reorder hero columns: live preview ABOVE form ── */
    /* Streamlit puts the form column first in DOM; flip visual order */
    ...
    /* iOS Safari zooms into inputs whose font is < 16px on focus.
       Bumping placeholder size to 16px prevents that ugly auto-zoom. */
    [data-testid="stTextInput"] input {
    ...
    /* ── Ticker tape (less aggressive on mobile) ────────── */
    .msp-ticker-chip {
        min-width: 138px;
        padding: 9px 11px;
        font-size: 12px;
    ...
    /* ── Story section: cleaner vertical flow ───────────── */
    .msp-story {
        gap: 18px !important;
    }
