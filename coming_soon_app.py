...
st.markdown(
    textwrap.dedent(
        ...
        * { box-sizing: border-box; }
        ...
        .msp-traffic { display: flex; gap: 7px; }
        ...
        .msp-signal-title h2 span { color: var(--blue2); }
...
with right:
    st.markdown(
        textwrap.dedent(
            """
            <div class="msp-visual" aria-label="MarketSignalPro product preview">
