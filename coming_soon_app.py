...
.msp-story-num {
    ...
    color: #5f7491;
    letter-spacing: 5px;
    /* letter-spacing adds 5px trailing space after the last char, which
       shifts the visible glyphs left of center. text-indent pushes the
       text right by the same amount to re-center the visible characters. */
    text-indent: 5px;
    margin: 0 auto 18px;
    opacity: .95;
    text-align: center;
...
@media (max-width: 620px) {
    ...
    .msp-story-step h4 {
        ...
        margin-bottom: 8px !important;
        /* Reset negative letter-spacing on mobile — at small sizes it shifts
           the visual glyphs left of the layout center, making the heading
           appear off-center even though text-align is center. */
        letter-spacing: -.2px !important;
    }
