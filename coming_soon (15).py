...
.visual{position:relative;min-height:770px;display:grid;align-items:center;justify-items:start;perspective:1200px;padding:20px 0 30px 0}
...
.panel-stack{position:relative;min-height:460px}
...
"""
    components.html(preview_html, height=790, scrolling=False)
