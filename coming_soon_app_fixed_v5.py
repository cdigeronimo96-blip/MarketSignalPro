...
left, right = st.columns([0.96, 1.04], gap="small", vertical_alignment="center")
...
.visual{position:relative;min-height:620px;display:grid;place-items:center;perspective:1200px}
...
"""
    components.html(preview_html, height=640, scrolling=False)
