...
.msp-story-icon {
    ...
    margin-bottom: 14px;
    line-height: 1;
    filter: drop-shadow(0 2px 12px rgba(96,165,250,.18));
}
...
<section class="msp-section msp-section-feature">
  <div class="msp-section-head">
    ...
    <p>
      Three quiet steps from the raw market to a decision you can actually defend —
      no noise, no jargon, just signal.
    </p>
  </div>
  ...
  <div class="msp-story">
    <div class="msp-story-step">
      ...
      <h4>Discover</h4>
      <p>
        17 composite signal categories — squeeze setups, hidden movers, sentiment flips, volume breakouts —
        surface the names already showing up across the data instead of the loudest headlines.
      </p>
    </div>
    ...
    <div class="msp-story-step">
      ...
      <h4>Understand</h4>
      <p>
        Each opportunity opens into a clean score breakdown: trend, momentum, volume, sentiment, and the BI matrix
        — every component visible so you see <em>why</em>, not just <em>what</em>.
      </p>
    </div>
    ...
    <div class="msp-story-step">
      ...
      <h4>Decide</h4>
      <p>
        Plain-English AI insights translate the full signal stack into one clear sentence,
        so the next step — watchlist, deeper research, or pass — actually feels obvious.
      </p>
    </div>
  </div>
""",
