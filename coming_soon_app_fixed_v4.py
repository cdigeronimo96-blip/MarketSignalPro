...
.visual{position:relative;min-height:540px;display:grid;place-items:center;perspective:1200px}
...
.insight{margin-top:14px;padding:16px;border-radius:20px;background:linear-gradient(135deg,rgba(37,99,235,.12),rgba(245,158,11,.08));border:1px solid rgba(255,255,255,.1)}.insight strong{color:#fff;display:block;margin-bottom:8px}.insight p{margin:0;color:#91a3be;line-height:1.55;font-size:13px}
@media(max-width:980px){.dashboard{transform:none}.visual{min-height:500px}}
</style>
</head>
<body>
<div class="visual">
...
"""
    components.html(preview_html, height=560, scrolling=False)
