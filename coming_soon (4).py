...
/* ============================================================
   HERO LAYOUT — narrow the columns row so left form & right preview
   sit close together in the page center, with only a small visual gap.
   Targets are written as DESCENDANT selectors (not direct-child) so
   they survive Streamlit wrapping the column's inner block in an
   extra container in newer Streamlit versions.
   ============================================================ */
...
/* Right-align every visible content element inside the left column
   so the headline, subhead, form, and proof pills all hug the center
   gutter (right edge of the left column).                              */
[data-testid="stHorizontalBlock"]:has(.msp-eyebrow) [data-testid="column"]:first-of-type .msp-eyebrow,
[data-testid="stHorizontalBlock"]:has(.msp-eyebrow) [data-testid="column"]:first-of-type .msp-h1,
[data-testid="stHorizontalBlock"]:has(.msp-eyebrow) [data-testid="column"]:first-of-type .msp-subhead,
[data-testid="stHorizontalBlock"]:has(.msp-eyebrow) [data-testid="column"]:first-of-type .msp-proof,
[data-testid="stHorizontalBlock"]:has(.msp-eyebrow) [data-testid="column"]:first-of-type [data-testid="stForm"] {
    max-width: 520px !important;
    width: 100% !important;
...
/* Constrain the column's inner block via descendant (not direct-child) */
[data-testid="stHorizontalBlock"]:has(.msp-eyebrow) [data-testid="column"]:first-of-type [data-testid="stVerticalBlock"] {
    max-width: 520px !important;
    margin-left: auto !important;
    margin-right: 0 !important;
}

/* Keep First/Last name columns inside the form unaffected */
...
section.main div[data-testid="stForm"] [data-testid="stVerticalBlock"] {
    max-width: none !important;
    margin: 0 !important;
}

/* Left-align the preview iframe snugly against the gutter */
[data-testid="stHorizontalBlock"]:has(.msp-eyebrow) [data-testid="column"]:last-of-type iframe {
