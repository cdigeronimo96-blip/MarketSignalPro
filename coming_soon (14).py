...
.visual{position:relative;min-height:800px;display:grid;align-items:center;justify-items:start;perspective:1200px;padding:20px 0 30px 0}
...
.panel-stack{position:relative;min-height:490px}
...
"""
    components.html(preview_html, height=820, scrolling=False)
